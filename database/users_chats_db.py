...
from info import DATABASE_NAME, DATABASE_URI, IMDB, IMDB_TEMPLATE, MELCOW_NEW_USERS, P_TTI_SHOW_OFF, SINGLE_BUTTON, SPELL_CHECK_REPLY, PROTECT_CONTENT, SELF_DELETE, MAX_BTN, CUSTOM_FILE_CAPTION, WELCOME_TEXT, AUTO_FFILTER, DOWNLOAD_TEXT_URL, SHORTLINK_API, SHORTLINK_URL, IS_SHORTLINK, ADMIN, SHARE, RULES, GROUP, CHANNEL, IS_TUTORIAL
